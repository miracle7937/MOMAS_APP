...
class DashboardBuilder{
   static List<GridItemModel> builder(Feature future, BuildContext context){
    List<GridItemModel> value = [];
    if(future.momasMeter== 1){
      value.add( GridItemModel(
          image: MoImage.momasPayment,
          title: "Make Payment",
          subtitle: "Buy more unit for your momas meter",
          onTap: (){
            Navigator.push(context,  MaterialPageRoute(builder: (builder)=>  const MomasPaymentScreen( momasPaymentType: MomasPaymentType.self,)));
          }
      ),);
    }
    if(future.otherMeter== 1){
      value.add( GridItemModel(
          ...
          onTap: (){
            Navigator.push(context,  MaterialPageRoute(builder: (builder)=>  const MomasPaymentScreen( momasPaymentType: MomasPaymentType.others,)));
          }
      ),);
    }
    if(future.printToken== 1){
      value.add(GridItemModel(
          ...
          onTap: (){
            Navigator.push(context,  MaterialPageRoute(builder: (builder)=> ReprintTokenScreen()));
          }
    ...
    if(future.accessToken== 1){
      value.add( GridItemModel(
          ...
          title: "Access Token",
          subtitle: "Generate and manage security token",
          onTap: (){
            Navigator.push(context,  MaterialPageRoute(builder: (builder)=>  const AccessTokenScreen()));
          }
      ),);
    }
      ...
      value.add(  GridItemModel(
          ...
          onTap: (){
            Navigator.push(context,
                MaterialPageRoute(builder: (builder)=>  const ServiceScreen()));
          }
    ...
    if(future.billPayment== 1){
      value.add(GridItemModel(
          ...
          onTap: (){
            Navigator.push(context,  MaterialPageRoute(builder: (builder)=>  const BillPaymentOptionsScreen()));
          }
    ...
    if(future.support== 1){
      value.add(GridItemModel(
          ...
          onTap: (){
            Navigator.push(context,  MaterialPageRoute(builder: (builder)=> const SupportScreen()));
          }
