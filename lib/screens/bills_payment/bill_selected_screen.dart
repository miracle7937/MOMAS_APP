...
class BillPaymentOptionsScreen extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              _buildPaymentOptionCard(
                ...
                Icons.phone_android,
                onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (builder)=>const AirtimeScreen()))
              ...
              _buildPaymentOptionCard(
                context,
                'Data Bundle',
                'Buy data for all Networks',
                Icons.data_usage,
                isSelected: false,
                  onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (builder)=>const DataScreen()))
              ),
              const SizedBox(height: 10),
              _buildPaymentOptionCard(
                context,
                'Cable',
                'Subscribe for  your cable',
                Icons.tv_outlined,
                isSelected: false,
                  onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (builder)=>const CableTvScreen()))
              ),
            ],
          ),
        ),
  ...
  Widget _buildPaymentOptionCard(BuildContext context, String title, String description, IconData icon, {bool isSelected = false,  VoidCallback? onTap}) {
