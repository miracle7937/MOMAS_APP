...
import 'package:momas_pay/bloc/dashboard_bloc/dashboard_bloc.dart';
import 'package:momas_pay/bloc/dashboard_bloc/dashboard_event.dart';
...
String name = "";
                                    ...
                                    builder: (context, state) {
                                      return SizedBox(
                                        ...
                                        child: ListView(
                                          ...
                                          children: state is PromotionSuccessful
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          quickWidget(
                              title: "Buy Units", image: MoImage.momasPayment),
                          quickWidget(
                              title: "Fund Wallet", image: MoImage.topUpWallet),
                          quickWidget(
                              title: "Services", image: MoImage.services),
                        ],
                      ),
                    ),
                  ),
  ...
  Widget quickWidget({required String image, String? title}) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(15.0),
