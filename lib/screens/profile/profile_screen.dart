          ...
          return SingleChildScrollView(
            child: Column(
              children: [
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        backgroundImage: AssetImage(
                            MoImage.profilePic), // Replace with your image asset
                      ),
                ...
                OptionTile(
                    icon: Icons.electric_meter, title: 'Request for a meter',
                onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (_)=>const RequestMeterScreen())),),
                OptionTile(icon: Icons.support_agent, title: 'Support',
                    onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (_)=>const SupportScreen()))
                ),
                OptionTile(icon: Icons.delete, title: 'Delete account', onTap: (){

                },),
                const OptionTile(icon: Icons.logout, title: 'Log out'),
              ],
            ),
          );
