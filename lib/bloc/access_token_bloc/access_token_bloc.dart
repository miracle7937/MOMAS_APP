...
class AccessTokenBloc extends Bloc<AccessTokenEvent, AccessTokenState> {
  ...
  Future mapEventToState(AccessTokenEvent event,  Emitter<AccessTokenState> emit) async {
  ...
  Future setEstate(AccessTokenEvent event,  Emitter<AccessTokenState> emit) async {
  ...
  Future generateToken(AccessTokenEvent event,  Emitter<AccessTokenState> emit) async {
